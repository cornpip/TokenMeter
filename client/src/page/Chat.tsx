        ...
        <div style={{ padding: "20px" }}>
            ...
            <div style={{ marginBottom: "20px" }}>
                ...
                <FormControl variant="outlined" style={{ marginRight: "10px" }}>
                    ...
                    <Select
                        value={newChat.is_answer}
                        onChange={(e) => setNewChat({ ...newChat, is_answer: Number(e.target.value) })}
                        label="Is Answer"
                    >
                        ...
                        {editingChatId === chat.id ? (
                            <>
                                ...
                                <TextField
                                    ...
                                    onChange={(e) =>
                                        setEditingChat({ ...editingChat, sequence: Number(e.target.value) })
                                    }
                                    variant="outlined"
                                    size="small"
                                />
                                <FormControl variant="outlined" size="small" style={{ marginLeft: "10px" }}>
                                    ...
                                    <Select
                                        ...
                                        onChange={(e) =>
                                            setEditingChat({ ...editingChat, is_answer: Number(e.target.value) })
                                        }
                                        label="Is Answer"
                                    >
                                        <MenuItem value={0}>No</MenuItem>
